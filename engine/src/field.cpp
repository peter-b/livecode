...
bool
MCField::ApplyState (MCRecordRef p_state)
{
	MCTypeInfoRef t_typeinfo;
	MCAssert(GetStateTypeInfo(t_typeinfo));
...
bool
MCField::GetStateTypeInfo (MCTypeInfoRef & r_type_info) const
{
...
MCTypeInfoRef MCField::kStateRecordTypeInfo;

bool
MCField::InitializeStatic (void)
{
