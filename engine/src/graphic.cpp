...
bool
MCGraphic::ApplyState (MCRecordRef p_state)
{
	MCTypeInfoRef t_typeinfo;
	MCAssert(GetStateTypeInfo(t_typeinfo));
...
bool
MCGraphic::GetStateTypeInfo (MCTypeInfoRef & r_type_info) const
{
...
MCTypeInfoRef MCGraphic::kStateRecordTypeInfo;

bool
MCGraphic::InitializeStatic (void)
{
